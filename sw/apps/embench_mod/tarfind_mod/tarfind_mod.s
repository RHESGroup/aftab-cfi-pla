...
init_heap_beebs:
	...
	lui	a5,0x102
	add	a1,a0,a1
	sw	a0,812(a5) # 10232c <heap_ptr>
	lui	a5,0x102
	sw	a1,808(a5) # 102328 <heap_end>
	lui	a5,0x102
	sw	zero,804(a5) # 102324 <heap_requested>
	ret
lab21: 	lui	a3,0x102
	lui	a2,0x102
	lui	a0,0x102
...
check_heap_beebs:
	lui	a5,0x102
	lw	a4,804(a5) # 102324 <heap_requested>
	lui	a5,0x102
...
malloc_beebs:
	...
	beqz	a0,lab22
	lui	a2,0x102
	lw	a0,812(a2) # 10232c <heap_ptr>
	lui	a3,0x102
	lw	a1,804(a3) # 102324 <heap_requested>
	add	a4,a0,a5
	andi	a6,a4,3
	add	a5,a5,a1
	bnez	a6,lab23
...
realloc_beebs:
	...
	lui	a2,0x102
	lw	a4,804(a2) # 102324 <heap_requested>
	add	a3,a0,a1
	andi	a7,a3,3
	add	a4,a1,a4
	bnez	a7,lab30
