...
WikiSort.constprop.0:
	...
	li	a6,0
	li	t3,0
	addi	s10,a5,-1240 # 101b28 <array1>
	li	t0,400
lab45: 	addi	t3,t3,25
	mv	t1,t6
	bge	a6,t6,lab40
...
benchmark_body.constprop.0:
	lui	a5,0x100
	mv	a5,a5
	lw	t3,0(a5) # 100000 <_conv_stat+0xf457c>
	lw	t1,4(a5)
	lw	a7,8(a5)
	lw	a6,12(a5)
	lw	a1,16(a5)
...
verify_benchmark:
	...
	lui	a5,0x100
	lui	a3,0x1
	addi	a5,a5,36 # 100024 <_conv_stat+0xf45a0>
	addi	a3,a3,-896 # c80 <WikiSort.constprop.0+0xd0>
	sw	a4,12(sp)
	add	a3,a5,a3
...
init_heap_beebs:
	...
	lui	a5,0x102
	add	a1,a0,a1
	sw	a0,2008(a5) # 1027d8 <heap_ptr>
	lui	a5,0x102
	sw	a1,2004(a5) # 1027d4 <heap_end>
	lui	a5,0x102
	sw	zero,2000(a5) # 1027d0 <heap_requested>
	ret
lab355: 	lui	a3,0x101
	lui	a2,0x101
	lui	a0,0x101
...
check_heap_beebs:
	lui	a5,0x102
	lw	a4,2000(a5) # 1027d0 <heap_requested>
	lui	a5,0x102
	lw	a5,2004(a5) # 1027d4 <heap_end>
	add	a0,a0,a4
	sltu	a0,a5,a0
	xori	a0,a0,1
	ret
malloc_beebs:
	...
	beqz	a0,lab356
	lui	a2,0x102
	lw	a0,2008(a2) # 1027d8 <heap_ptr>
	lui	a3,0x102
	lw	a1,2000(a3) # 1027d0 <heap_requested>
	add	a4,a0,a5
	andi	a6,a4,3
	add	a5,a5,a1
	bnez	a6,lab357
...
calloc_beebs:
	...
	beqz	a2,lab359
	lui	a0,0x102
	lw	a5,2008(a0) # 1027d8 <heap_ptr>
	lui	a1,0x102
	lw	a4,2000(a1) # 1027d0 <heap_requested>
	add	a3,a5,a2
	andi	a7,a3,3
	add	a4,a2,a4
	bnez	a7,lab360
	sw	a4,2000(a1)
	lui	a4,0x102
	lw	a4,2004(a4) # 1027d4 <heap_end>
	bltu	a4,a3,lab359
lab362: 	sw	a3,2008(a0)
	beqz	a5,lab361
	addi	sp,sp,-16
	li	a1,0
	mv	a0,a5
...
realloc_beebs:
	...
	beqz	a1,lab363
	lui	a6,0x102
	lw	a0,2008(a6) # 1027d8 <heap_ptr>
	lui	a2,0x102
	lw	a4,2000(a2) # 1027d0 <heap_requested>
	add	a3,a0,a1
	andi	a7,a3,3
	add	a4,a1,a4
	bnez	a7,lab364
...
__adddf3:
	lui	a6,0x100
	addi	a6,a6,-1 # fffff <_conv_stat+0xf457b>
	addi	sp,sp,-32
	and	a7,a6,a1
	srli	a4,a1,0x14
	srli	a5,a0,0x1d
...
lab473: 	slli	a4,a4,0x10
	...
	or	t6,a4,a5
	sub	s0,s0,a7
	addi	a7,t2,-1 # ffff <_conv_stat+0x457b>
	and	a5,t6,a7
	srli	t4,t6,0x10
	srli	t3,a1,0x10
	and	a7,a1,a7
...
lab474: 	srli	a5,a4,0x10
	add	a5,a5,t4
	lui	t4,0x10
	addi	t4,t4,-1 # ffff <_conv_stat+0x457b>
	and	a4,a4,t4
	slli	a4,a4,0x10
	and	t0,t0,t4
	add	a4,a4,t0
...
lab482: 	srli	a7,a0,0x10
	add	a7,a7,t1
	lui	t1,0x10
	addi	t1,t1,-1 # ffff <_conv_stat+0x457b>
	and	a0,a0,t1
	slli	a0,a0,0x10
	and	t4,t4,t1
	add	a0,a0,t4
...
__ledf2:
	lui	a4,0x100
	addi	a4,a4,-1 # fffff <_conv_stat+0xf457b>
	srli	a6,a1,0x14
	and	a7,a4,a1
	mv	a5,a0
	mv	t1,a0
...
lab556: 	add	s3,s3,a4
	...
	bgeu	a3,a4,lab531
lab559: 	lui	t3,0x10
	addi	t1,t3,-1 # ffff <_conv_stat+0x457b>
	srli	a6,s2,0x10
	srli	a0,a5,0x10
	and	s2,s2,t1
	and	t4,a5,t1
...
lab532: 	and	a3,a4,t1
	...
	add	a6,a6,t1
lab533: 	lui	s2,0x10
	addi	t6,s2,-1 # ffff <_conv_stat+0x457b>
	srli	t1,a4,0x10
	and	t5,t5,t6
	and	a4,a4,t6
	srli	s0,s1,0x10
...
lab534: 	srli	t4,a4,0x10
	add	t4,t4,s1
	lui	s1,0x10
	addi	a0,s1,-1 # ffff <_conv_stat+0x457b>
	and	a4,a4,a0
	and	t2,t2,a0
	slli	a4,a4,0x10
	mul	a0,s0,t3
	...
	add	a6,a6,s1
lab535: 	lui	a0,0x10
	addi	a0,a0,-1 # ffff <_conv_stat+0x457b>
	and	a5,t6,a0
	and	t2,t2,a0
	slli	a5,a5,0x10
	add	a7,a7,t0
...
lab581: 	lui	a4,0x800
	and	a4,a5,a4
	beqz	a4,lab583
	addi	s0,s0,1 # 80001 <_conv_stat+0x7457d>
	li	a4,2047
	beq	s0,a4,lab586
	lui	a4,0xff800
	addi	a4,a4,-1 # ff7fffff <_stack+0xff6effff>
...
__unorddf2:
	lui	a5,0x100
	addi	a5,a5,-1 # fffff <_conv_stat+0xf457b>
	and	a4,a5,a1
	srli	a1,a1,0x14
	and	a5,a5,a3
	andi	a1,a1,2047
...
__fixdfsi:
	srli	a4,a1,0x14
	lui	a3,0x100
	addi	a5,a3,-1 # fffff <_conv_stat+0xf457b>
	andi	a4,a4,2047
	li	a2,1022
	and	a5,a5,a1
	srli	a1,a1,0x1f
...
lab667: 	lui	a4,0x101
	...
	add	a5,a5,a0
	lbu	a0,0(a5) # 10000 <_conv_stat+0x457c>
	sub	a0,a3,a0
	ret
...
lab681: 	lw	a2,0(a0)
	lw	a3,0(a1) # 800000 <_stack+0x6f0000>
	and	t0,a2,a5
	or	t1,a2,a5
	add	t0,t0,a5
	or	t0,t0,t1
...
lab678: 	addi	a0,a0,8
	...
	li	a0,0
	ret
lab679: 	addi	a0,a0,12
	addi	a1,a1,12
	bne	a2,a3,lab674
	li	a0,0
	ret
lab680: 	addi	a0,a0,16
	addi	a1,a1,16
	bne	a2,a3,lab674
	li	a0,0
	ret
