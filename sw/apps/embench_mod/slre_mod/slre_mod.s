...
lab18: 	li	a5,91
	...
	add	a3,t4,s6
lab76: 	mv	s4,t6
lab93: 	lw	a5,-1688(s5) # 968 <bar+0x49c>
	beqz	a5,lab40
	slli	s1,s1,0x3
	add	a5,a5,s1
	sw	s8,0(a5)
...
lab107: 	slli	a1,a5,0x3
	...
	sw	a5,-1692(s4)
	addi	s7,s7,1
lab135: 	blt	s7,s9,lab108
lab136: 	bnez	s6,lab109
	lui	a5,0x1
	add	a5,s0,a5
...
lab150: 	li	a3,0
	...
	li	a1,0
	bge	a3,a0,lab116
lab120: 	slli	a4,a3,0x3
	add	a4,s0,a4
	j	lab117
lab119: 	lw	a5,0(a2) # 1000 <foo+0x1f0>
	addi	a3,a3,1
	addi	a5,a5,1
	sw	a5,0(a2)
	beq	a3,a0,lab118
