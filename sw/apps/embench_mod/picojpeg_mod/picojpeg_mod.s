...
lab15: 	lbu	a1,0(a3)
	...
	slli	s0,a1,0x10
	slli	s3,t2,0x10
	addi	a1,s4,-256 # fff00 <__DTOR_END__+0xf9d2c>
	srai	s0,s0,0x10
	slli	a1,a1,0x10
	srli	s3,s3,0x10
	srli	a1,a1,0x10
	slti	s5,s0,256
	addi	s2,s3,-256 # fff00 <__DTOR_END__+0xf9d2c>
	sltu	a1,a1,a2
	xori	s1,s5,1
	slli	s2,s2,0x10
	srli	s2,s2,0x10
...
upsampleCbV:
	lui	a7,0x100
	addi	a7,a7,44 # 10002c <gCoeffBuf>
	addi	t4,a7,128
	slli	a0,a0,0x1
	addi	t5,a7,384
	addi	a0,a0,16
...
getOctet.part.0:
	...
	sw	s1,4(sp)
	lui	s1,0x101
	lbu	a4,-1696(s1) # 100960 <gInBufLeft>
	sw	ra,12(sp)
	sw	s0,8(sp)
	sw	s2,0(sp)
	beqz	a4,lab104
...
lab104: 	lui	a4,0x101
	...
	lui	a5,0x101
	sb	a0,-1771(a5) # 100915 <gCallbackStatus>
lab106: 	lbu	a4,-1696(s1)
	bnez	a4,lab107
	lui	a0,0x101
	lbu	a1,-1694(a0) # 100962 <gTemFlag>
	lbu	a5,-1695(s2)
	not	a1,a1
	zext.b	a1,a1
	snez	a2,a1
...
huffDecode:
	...
	lui	s7,0x101
	lui	s8,0x101
	lhu	a5,-1698(s7) # 10095e <gBitBuf>
	lbu	a4,-1700(s8) # 10095c <gBitsLeft>
	sw	s0,72(sp)
	sw	s1,68(sp)
	sw	ra,76(sp)
	sw	s2,64(sp)
...
lab118: 	addi	a4,a4,-1
	...
	addi	s11,s0,32
	li	s10,0
	addi	s6,a6,-1 # ffff <__DTOR_END__+0x9e2b>
	li	s1,255
	lui	s5,0x101
...
lab114: 	sw	a0,12(sp)
	...
	lbu	a1,-1696(s4) # 100960 <gInBufLeft>
	addi	a4,a5,-1
	zext.b	a4,a4
	addi	a5,a5,-2
	zext.b	a5,a5
...
getBits.constprop.2:
	...
	lui	s3,0x101
	li	a3,8
	lbu	a4,-1700(s3) # 10095c <gBitsLeft>
	mv	s1,a0
	mv	a5,s0
	mv	s2,a0
	bltu	a3,a0,lab120
...
processMarkers:
	...
	sw	a5,136(sp)
	lui	a5,0x101
	addi	a3,a5,-788 # 100cec <CSWTCH.306>
	lbu	a4,-1700(s9) # 10095c <gBitsLeft>
	lhu	a5,-1698(s5) # 10095e <gBitBuf>
	sw	s10,160(sp)
	sw	ra,204(sp)
	sw	s0,200(sp)
	sw	s1,196(sp)
...
lab177: 	bltu	a5,a1,lab132
	...
	lhu	a5,-1698(s5)
	lbu	a4,-1700(s9)
	addi	a3,a3,-1 # ffff <__DTOR_END__+0x9e2b>
	li	s8,7
	li	s7,8
	sw	a3,0(sp)
...
lab176: 	andi	a1,a3,14
	...
	lui	a0,0x101
	srli	a3,a3,0x3
	lbu	a1,-1692(a0) # 100964 <gValidHuffTables>
	andi	a3,a3,2
	andi	a2,a2,1
	or	s11,a3,a2
	li	a2,1
...
lab133: 	addi	a5,a1,59
	...
	sll	a4,a4,a5
	lui	a5,0x80
	addi	a5,a5,-2040 # 7f808 <__DTOR_END__+0x79634>
	and	a5,a4,a5
	bnez	a5,lab178
	andi	a4,a4,1911
	bnez	a4,lab180
...
lab233: 	srli	a2,s4,0xc
	...
	bnez	a3,lab221
	beqz	a5,lab222
	lbu	a5,-1693(s3) # 100963 <gValidQuantTables>
	ori	a5,a5,2
	sb	a5,-1693(s3)
	lw	a5,0(sp)
	bnez	a5,lab223
...
lab184: 	jal	ra,getBits.constprop.1
	...
	lhu	a5,-1698(s5)
	lbu	a4,-1700(s9)
	sh	a0,-1724(a3) # 100944 <gRestartInterval>
	j	lab137
getBits.constprop.0:
	addi	sp,sp,-32
	sw	s3,12(sp)
...
pjpeg_decode_mcu:
	...
	lui	a5,0x101
	sw	s6,80(sp)
	lbu	s6,-1771(a5) # 100915 <gCallbackStatus>
	sw	ra,108(sp)
	sw	s0,104(sp)
	sw	s1,100(sp)
	sw	s2,96(sp)
...
lab272: 	addi	a5,a5,-1688 # 100968 <gLastDC>
	...
	lui	a3,0x101
	sw	a5,16(sp)
	addi	a5,a3,44 # 10102c <ZAG+0x2a0>
	sw	a5,36(sp)
	lui	a5,0x100
	lui	a4,0x101
	lui	s0,0x100
	addi	a5,a5,60 # 10003c <gCoeffBuf+0x10>
	addi	s10,a4,-788 # 100cec <CSWTCH.306>
	li	s5,0
...
lab265: 	lh	a5,0(s7)
	...
	zext.b	a5,a5
lab268: 	lui	a4,0x101
	lw	a4,-1744(a4) # 100930 <gScanType>
	li	a2,4
	bltu	a2,a4,lab269
	lui	a2,0x101
	slli	a4,a4,0x2
...
lab256: 	addi	a5,a5,-1
	lui	a4,0x101
	sh	a5,-1754(a4) # 100926 <gNumMCUSRemaining>
	j	lab253
	li	a4,2
	bne	s5,a4,lab274
	j	lab275
...
lab277: 	sb	a5,640(s7)
	...
	lui	a2,0x101
	slli	a4,s5,0x2
	addi	a2,a2,-856 # 100ca8 <config_mem_words+0x3c>
	add	a4,a4,a2
	lw	a4,0(a4)
	jr	a4
	sb	a5,640(s7)
...
lab331: 	addi	a5,a5,2
	...
	lui	a4,0x101
	slli	a5,s5,0x2
	addi	a4,a4,-812 # 100cd4 <config_mem_words+0x68>
	add	a5,a5,a4
	lw	a5,0(a5)
	jr	a5
	li	a5,2
...
lab349: 	lui	a3,0x101
	...
	lui	a5,0x101
	addi	a4,a4,1
	addi	a1,a5,-1688 # 100968 <gLastDC>
	andi	a4,a4,7
	sh	a4,-1726(a3)
	sw	zero,-1688(a5)
	li	a4,8
...
pjpeg_decode_init:
	...
	sw	s11,44(sp)
	lui	s0,0x101
	sb	zero,-1705(a5) # 100957 <gCompsInFrame>
	lui	a5,0x101
	sw	zero,0(a0)
	sw	zero,4(a0)
	sw	zero,8(a0)
...
lab437: 	jal	ra,getBits.constprop.1
	...
	addi	s6,s7,-1712 # 100950 <gCompHSamp>
	addi	s8,s10,-1716 # 10094c <gCompVSamp>
	sw	a5,0(sp)
	li	s1,4
	li	s11,1
	j	lab445
...
lab471: 	srai	s2,s2,0xc
	...
	bltu	s11,a5,lab447
	lui	a5,0x101
	lbu	a3,-1705(a5) # 100957 <gCompsInFrame>
	bgeu	s9,a3,lab448
lab445: 	li	a0,0
	jal	ra,getBits.constprop.0
	cfed 786
...
lab470: 	lhu	a4,-1704(a4) # 100958 <gImageYSize>
	...
	mul	a3,a4,a5
	lui	s1,0x101
	sh	a4,-1750(s1) # 10092a <gMaxMCUSPerRow>
	lui	a4,0x101
	sh	a5,-1752(a4) # 100928 <gMaxMCUSPerCol>
	addi	a0,sp,31
	lui	a5,0x101
	...
	lui	a3,0x101
	slli	s11,a2,0x10
	sb	a5,-1729(a3) # 10093f <gCompsInScan>
	srli	s11,s11,0x10
	addi	a4,a4,3
	bne	s11,a4,lab454
	addi	a5,a5,-1
...
lab472: 	zext.b	a5,a5
	...
	lui	a5,0x101
	lbu	t3,-1705(a5) # 100957 <gCompsInFrame>
	lui	a5,0x101
	lhu	a0,-1752(a5) # 100928 <gMaxMCUSPerCol>
	lw	a5,8(sp)
	lw	t1,-1744(s6)
	lhu	a6,-1750(s1)
	lbu	a1,-1747(a5)
