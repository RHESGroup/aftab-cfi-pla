...
benchmark_body:
	...
	sw	a5,12(sp)
	lui	a5,0x100
	addi	a5,a5,4 # 100004 <array+0x4>
	sw	a5,24(sp)
	lui	a5,0x10
	lui	a6,0x100
	lui	s1,0x100
	lui	s6,0x100
	addi	a5,a5,1 # 10001 <__DTOR_END__+0xbde1>
	sw	zero,16(sp)
	addi	s11,a6,912 # 100390 <array2>
	addi	s1,s1,400 # 100190 <array_exp.0>
	lui	s5,0x102
	addi	s6,s6,1312 # 100520 <htab>
	li	s7,100
	li	s4,1
	sw	a5,28(sp)
lab573: 	lw	a5,12(sp)
...
lab508: 	lui	a5,0x100
	lui	a1,0x2
	addi	a0,a5,1392 # 100570 <heap>
	jal	ra,init_heap_beebs
	lw	s0,12(sp)
	sw	zero,1392(s5) # 102570 <the_list>
	mv	s3,s0
	j	lab522
lab525: 	lw	a4,8(a5)
	sw	a5,4(a0)
...
lab553: 	lw	a7,76(sp)
	addi	t4,sp,472
lab579: 	lw	a5,36(sp)
	addi	a1,a1,-1 # 1fff <sglib_hashed_ilist_add+0x17>
	add	a5,a5,a7
	lw	a7,0(t4)
	sw	a5,36(sp)
	sw	a7,76(sp)
...
lab637: 	addi	sp,sp,-16
	...
	sw	s1,4(sp)
	sw	ra,12(sp)
	addi	s1,a2,400 # 100190 <array_exp.0>
	addi	a7,s0,912 # 100390 <array2>
	li	a6,20
lab644: 	lw	a3,0(a2)
	remu	a5,a3,a6
	slli	a5,a5,0x2
...
lab641: 	lw	a4,0(a5)
	...
	bne	s1,a2,lab644
	lui	a5,0x4
	addi	a5,a5,-1334 # 3aca <sglib_rbtree_it_init_postorder+0xae>
	beq	a0,a5,lab645
lab642: 	li	a0,0
lab646: 	lw	ra,12(sp)
	lw	s0,8(sp)
...
rand_beebs:
	lui	a4,0x102
	lw	a0,1408(a4) # 102580 <seed>
	lui	a5,0x41c65
	addi	a5,a5,-403 # 41c64e6d <_stack+0x41b5ce6d>
	mul	a0,a0,a5
	lui	a5,0x3
	addi	a5,a5,57 # 3039 <benchmark_body+0x2a1>
	add	a0,a0,a5
	slli	a0,a0,0x1
	srli	a0,a0,0x1
	sw	a0,1408(a4)
...
init_heap_beebs:
	...
	lui	a5,0x102
	add	a1,a0,a1
	sw	a0,1404(a5) # 10257c <heap_ptr>
	lui	a5,0x102
	sw	a1,1400(a5) # 102578 <heap_end>
	lui	a5,0x102
	sw	zero,1396(a5) # 102574 <heap_requested>
	ret
lab647: 	lui	a3,0x100
	lui	a2,0x100
	lui	a0,0x100
	addi	sp,sp,-16
	addi	a3,a3,816 # 100330 <__func__.0+0x10>
	addi	a2,a2,800 # 100320 <__func__.0>
	li	a1,65
	addi	a0,a0,848 # 100350 <__func__.0+0x30>
	sw	ra,12(sp)
	jal	ra,__assert_func
check_heap_beebs:
	lui	a5,0x102
	lw	a4,1396(a5) # 102574 <heap_requested>
	lui	a5,0x102
	lw	a5,1400(a5) # 102578 <heap_end>
	add	a0,a0,a4
	sltu	a0,a5,a0
	xori	a0,a0,1
	ret
malloc_beebs:
	...
	beqz	a0,lab648
	lui	a2,0x102
	lw	a0,1404(a2) # 10257c <heap_ptr>
	lui	a3,0x102
	lw	a1,1396(a3) # 102574 <heap_requested>
	add	a4,a0,a5
	andi	a6,a4,3
	add	a5,a5,a1
	bnez	a6,lab649
...
calloc_beebs:
	...
	beqz	a2,lab651
	lui	a0,0x102
	lw	a5,1404(a0) # 10257c <heap_ptr>
	lui	a1,0x102
	lw	a4,1396(a1) # 102574 <heap_requested>
	add	a3,a5,a2
	andi	a7,a3,3
	add	a4,a2,a4
	bnez	a7,lab652
	sw	a4,1396(a1)
	lui	a4,0x102
	lw	a4,1400(a4) # 102578 <heap_end>
	bltu	a4,a3,lab651
lab654: 	sw	a3,1404(a0)
	beqz	a5,lab653
	addi	sp,sp,-16
	li	a1,0
	mv	a0,a5
...
realloc_beebs:
	...
	beqz	a1,lab655
	lui	a6,0x102
	lw	a0,1404(a6) # 10257c <heap_ptr>
	lui	a2,0x102
	lw	a4,1396(a2) # 102574 <heap_requested>
	add	a3,a0,a1
	andi	a7,a3,3
	add	a4,a1,a4
	bnez	a7,lab656
