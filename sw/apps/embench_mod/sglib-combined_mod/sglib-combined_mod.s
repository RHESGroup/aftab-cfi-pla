...
sglib_rbtree_len:
	...
	li	a0,0
	sub	t1,t1,t3
	addi	t4,t4,-1 # 3fffffff <_stack+0x3feeffff>
...
benchmark_body:
	...
	lui	s1,0x100
	lui	s6,0x101
	addi	a5,a5,1 # 10001 <__errno+0x6a7d>
	sw	zero,16(sp)
	addi	s11,a6,80 # 101050 <array2>
	addi	s1,s1,400 # 100190 <array_exp.0>
	lui	s5,0x103
	addi	s6,s6,480 # 1011e0 <htab>
	li	s7,100
	li	s4,1
	sw	a5,28(sp)
lab573: 	lw	a5,12(sp)
...
lab508: 	lui	a5,0x101
	lui	a1,0x2
	addi	a0,a5,560 # 101230 <heap>
	jal	ra,init_heap_beebs
	lw	s0,12(sp)
	sw	zero,600(s5) # 103258 <the_list>
	mv	s3,s0
	j	lab522
lab525: 	lw	a4,8(a5)
	sw	a5,4(a0)
...
init_heap_beebs:
	...
	lui	a5,0x103
	add	a1,a0,a1
	sw	a0,612(a5) # 103264 <heap_ptr>
	lui	a5,0x103
	sw	a1,608(a5) # 103260 <heap_end>
	lui	a5,0x103
	sw	zero,604(a5) # 10325c <heap_requested>
	ret
lab647: 	lui	a3,0x100
	lui	a2,0x100
	lui	a0,0x100
...
check_heap_beebs:
	lui	a5,0x103
	lw	a4,604(a5) # 10325c <heap_requested>
	lui	a5,0x103
	lw	a5,608(a5) # 103260 <heap_end>
	add	a0,a0,a4
	sltu	a0,a5,a0
	xori	a0,a0,1
	ret
malloc_beebs:
	...
	beqz	a0,lab648
	lui	a2,0x103
	lw	a0,612(a2) # 103264 <heap_ptr>
	lui	a3,0x103
	lw	a1,604(a3) # 10325c <heap_requested>
	add	a4,a0,a5
	andi	a6,a4,3
	add	a5,a5,a1
	bnez	a6,lab649
...
calloc_beebs:
	...
	beqz	a2,lab651
	lui	a0,0x103
	lw	a5,612(a0) # 103264 <heap_ptr>
	lui	a1,0x103
	lw	a4,604(a1) # 10325c <heap_requested>
	add	a3,a5,a2
	andi	a7,a3,3
	add	a4,a2,a4
	bnez	a7,lab652
...
realloc_beebs:
	...
	beqz	a1,lab655
	lui	a6,0x103
	lw	a0,612(a6) # 103264 <heap_ptr>
	lui	a2,0x103
	lw	a4,604(a2) # 10325c <heap_requested>
	add	a3,a0,a1
	andi	a7,a3,3
	add	a4,a1,a4
	bnez	a7,lab656
...
memset:
	...
	andi	a5,a4,15
	bnez	a5,lab663
lab667: 	bnez	a1,lab664
lab666: 	andi	a3,a2,-16
	andi	a2,a2,15
	add	a3,a3,a4
lab665: 	sw	a1,0(a4)
	sw	a1,4(a4)
...
lab672: 	addi	a0,a0,8
	...
	li	a0,0
	ret
lab673: 	addi	a0,a0,12
	addi	a1,a1,12
	bne	a2,a3,lab668
	li	a0,0
	ret
lab674: 	addi	a0,a0,16
	addi	a1,a1,16
	bne	a2,a3,lab668
	li	a0,0
	ret
