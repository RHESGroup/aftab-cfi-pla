...
lab125: 	sw	a0,0(a1)
	...
	bnez	a4,lab139
	sw	a5,12(s3)
lab140: 	jal	ra,sglib___rbtree_fix_right_deletion_discrepancy
	beqz	a0,lab136
...
sglib_dllist_delete_if_member:
	...
	mv	a5,a6
	j	lab238
lab240: 	beqz	a5,lab239
lab238: 	lw	a4,0(a5)
	bne	a4,a3,lab240
	sw	a5,0(a2)
	lw	a1,0(a0)
	beq	a1,a5,lab241
lab249: 	beqz	a3,lab242
	lw	a4,8(a5)
lab245: lab242: 	lw	a4,8(a5)
	beqz	a4,lab243
lab246: lab243: 	sw	a1,0(a0)
	lw	a0,0(a2)
	snez	a0,a0
	ret
lab241: 	lw	a4,8(a5)
...
sglib_ilist_sort:
	...
	li	a0,1
	li	a7,1
lab341: 	beqz	a2,lab327
	li	a1,0
	addi	a3,sp,12
lab340: 	li	a5,1
	bne	a0,a7,lab328
	j	lab329
lab331: lab328: 	addi	a5,a5,1
	lw	a4,4(a4)
	bne	a5,a0,lab331
	beqz	a4,lab330
	lw	a5,4(a4)
...
sglib_hashed_ilist_it_next:
	...
	bnez	s0,lab380
	j	lab381
lab382: 	beqz	s0,lab381
lab380: 	mv	a0,s0
	mv	a1,s3
	jalr	s2
	bnez	a0,lab382
lab391: lab383: 	sw	a5,4(s1)
lab394: 	mv	a0,s0
	lw	s0,24(sp)
	lw	s1,20(sp)
	lw	s2,16(sp)
...
lab526: 	li	a2,80
	...
	lw	s9,12(sp)
	li	s10,20
lab532: 	remu	s2,s0,s10
	slli	s2,s2,0x2
	add	s2,s6,s2
	lw	a5,0(s2)
	bnez	a5,lab529
	j	lab530
lab531: 	beqz	a5,lab530
lab529: 	lw	a4,0(a5)
	bne	s0,a4,lab531
	addi	s9,s9,4
	bne	s9,s1,lab532
lab555: 	sw	s6,60(sp)
	...
	li	s9,0
	li	s0,0
lab558: 	sw	zero,48(sp)
	addi	a5,a5,1
	sw	a5,36(sp)
	beqz	s0,lab534
lab538: 	bnez	s2,lab535
	j	lab536
lab537: 	beqz	s2,lab536
lab535: 	mv	a0,s2
	mv	a1,s10
	jalr	s0
	bnez	a0,lab537
	sw	s2,44(sp)
lab539: 	sw	zero,48(sp)
	lw	s2,4(s2)
	addi	a5,a5,1
	sw	a5,36(sp)
	bnez	s0,lab538
...
lab553: 	lw	a7,76(sp)
	addi	t4,sp,472
lab579: 	addi	a1,a1,-1 # 1fff <sglib_ilist_it_next+0xa3>
	add	a5,a5,a7
	lw	a7,0(t4)
	sw	a5,36(sp)
	sw	a7,76(sp)
...
lab563: 	addi	s3,s3,4
	...
	li	a4,0
	bgeu	s4,a3,lab566
lab569: 	srai	a5,a5,0x10
	li	a1,1
	blez	a5,lab567
lab572: 	slli	a3,a4,0x10
	srai	a3,a3,0x10
	addi	a2,a3,1104
	addi	a0,sp,32
	add	a2,a2,a0
...
lab578: lab574: 	slli	a5,t3,0x2
	...
	bge	a4,a1,lab576
	mv	a0,a7
lab581: 	addi	a5,a5,1104
	addi	a2,sp,32
	add	a5,a5,a2
	lw	a5,-1060(a5)
	blt	a0,a5,lab577
lab580: 	addi	a5,a2,1104
	addi	a4,sp,32
	add	a2,a5,a4
	slli	a5,a3,0x2
	slli	a4,a3,0x1
...
sglib_rbtree_it_init:
	...
	li	a7,2
	bgeu	a6,a2,lab598
lab602: 	srai	a4,a4,0x10
	sh	a4,644(a5)
	blez	a4,lab599
lab605: 	slli	a2,a3,0x10
	srai	a2,a2,0x10
	add	a1,a5,a2
	lbu	a1,4(a1)
	beq	a1,a7,lab600
...
sglib_rbtree_it_init_inorder:
	...
	li	a3,0
	bgeu	a6,a2,lab611
lab615: 	srai	a4,a4,0x10
	sh	a4,644(a5)
	blez	a4,lab612
lab618: 	slli	a2,a3,0x10
	srai	a2,a2,0x10
	add	a1,a5,a2
	lbu	a1,4(a1)
	beq	a1,a6,lab613
...
sglib_rbtree_it_init_postorder:
	...
	li	a7,2
	bgeu	a6,a2,lab623
lab627: 	srai	a4,a4,0x10
	sh	a4,644(a5)
	blez	a4,lab624
lab630: 	slli	a2,a3,0x10
	srai	a2,a2,0x10
	add	a1,a5,a2
	lbu	a1,4(a1)
	beq	a1,a7,lab625
...
lab637: 	addi	sp,sp,-16
	...
	mv	a7,s0
	li	a6,20
lab644: 	remu	a5,a3,a6
	slli	a5,a5,0x2
	add	a5,a7,a5
	lw	a5,400(a5)
	bnez	a5,lab641
	j	lab642
lab643: 	beqz	a5,lab642
lab641: 	lw	a4,0(a5)
	bne	a3,a4,lab643
	addi	a2,a2,4
	bne	s1,a2,lab644
