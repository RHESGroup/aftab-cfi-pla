...
benchmark_body:
	...
	lui	s1,0x100
	lui	s6,0x101
	addi	a5,a5,1 # 10001 <__errno+0x7935>
	sw	zero,16(sp)
	addi	s11,a6,64 # 101040 <array2>
	addi	s1,s1,400 # 100190 <array_exp.0>
	lui	s5,0x103
	addi	s6,s6,464 # 1011d0 <htab>
	li	s7,100
	li	s4,1
	sw	a5,28(sp)
lab573: 	lw	a5,12(sp)
...
lab508: 	lui	a5,0x101
	lui	a1,0x2
	addi	a0,a5,544 # 101220 <heap>
	jal	ra,init_heap_beebs
	lw	s0,12(sp)
	sw	zero,584(s5) # 103248 <the_list>
	mv	s3,s0
	j	lab522
lab525: 	lw	a4,8(a5)
	sw	a5,4(a0)
...
init_heap_beebs:
	...
	lui	a5,0x103
	add	a1,a0,a1
	sw	a0,596(a5) # 103254 <heap_ptr>
	lui	a5,0x103
	sw	a1,592(a5) # 103250 <heap_end>
	lui	a5,0x103
	sw	zero,588(a5) # 10324c <heap_requested>
	ret
lab647: 	lui	a3,0x100
	lui	a2,0x100
	lui	a0,0x100
...
check_heap_beebs:
	lui	a5,0x103
	lw	a4,588(a5) # 10324c <heap_requested>
	lui	a5,0x103
	lw	a5,592(a5) # 103250 <heap_end>
	add	a0,a0,a4
	sltu	a0,a5,a0
	xori	a0,a0,1
	ret
malloc_beebs:
	...
	beqz	a0,lab648
	lui	a2,0x103
	lw	a0,596(a2) # 103254 <heap_ptr>
	lui	a3,0x103
	lw	a1,588(a3) # 10324c <heap_requested>
	add	a4,a0,a5
	andi	a6,a4,3
	add	a5,a5,a1
	bnez	a6,lab649
...
calloc_beebs:
	...
	beqz	a2,lab651
	lui	a0,0x103
	lw	a5,596(a0) # 103254 <heap_ptr>
	lui	a1,0x103
	lw	a4,588(a1) # 10324c <heap_requested>
	add	a3,a5,a2
	andi	a7,a3,3
	add	a4,a2,a4
	bnez	a7,lab652
...
realloc_beebs:
	...
	beqz	a1,lab655
	lui	a6,0x103
	lw	a0,596(a6) # 103254 <heap_ptr>
	lui	a2,0x103
	lw	a4,588(a2) # 10324c <heap_requested>
	add	a3,a0,a1
	andi	a7,a3,3
	add	a4,a1,a4
	bnez	a7,lab656
